...
Edit and commit your C# code via Termux.

Push your changes: git push origin main.

Open GitHub Mobile / Browser -> Navigate to Actions -> Build cTrader Algorithms.

Tap Run workflow, enter the target folder name (e.g., Momentum V6), and execute.

Download the .algo artifact zip from the run summary, extract it, and tap the .algo file to instantly install it into cTrader Mobile.
